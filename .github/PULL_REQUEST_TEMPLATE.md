...
Fill this out if you want your template to be added to the ai-apps gallery!
...
- [ ] Added an entry to https://github.com/Azure/ai-apps/blob/main/website/src/data/users.tsx that includes:
    ...
    - [ ] **Tags** - Specify [tags](https://github.com/Azure/ai-apps/blob/main/website/src/data/tags.tsx) to represent the template. If you don't see a relevant tag for your template? Feel free to add one!
        
        **Required tags**:
      - [ ] At least 1 tag for programming language used
      - [ ] At least 1 tag for model used
      - [ ] At least 1 tag for task used
...
# If you are submitting a resource to be added to the ai-apps README:
- [ ] Name of resource
